      ...
      return [r].flat().reduce((s4, a2) => {
        if (a2 != null) {
          ...
          if (u2 === "string" || u2 === "number") s4.push(a2);
            ...
            let c3 = Array.isArray(a2) ? o(n2, a2) : Object.entries(a2).map(([f2, g3]) => n2 === "style" && (g3 || g3 === 0) ? `${f2.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}:${g3}` : g3 ? f2 : void 0);
...
var d = (t2, e, a2) => e in t2 ? p3(t2, e, { enumerable: true, configurable: true, writable: true, value: a2 }) : t2[e] = a2;
var n = (t2, e) => {
  for (var a2 in e || (e = {})) x2.call(e, a2) && d(t2, a2, e[a2]);
  if (i2) for (var a2 of i2(e)) c2.call(e, a2) && d(t2, a2, e[a2]);
  return t2;
};
function u(...t2) {
  if (t2) {
...
//# sourceMappingURL=chunk-47D2QLSA.js.map
